...
router.get('/payments', async (req: Request, res: Response) => {
  ...
  await proxyRequest('GET', `${PAYMENT_SERVICE_URL}/payments`, req, res);
});
...
router.post('/payments', async (req: Request, res: Response) => {
  ...
  await proxyRequest('POST', `${PAYMENT_SERVICE_URL}/payments`, req, res);
});
...
router.get('/payments/booking/:bookingId', async (req: Request, res: Response) => {
  ...
  await proxyRequest('GET', `${PAYMENT_SERVICE_URL}/payments/booking/${req.params.bookingId}`, req, res);
});
...
router.get('/payments/:id', async (req: Request, res: Response) => {
  ...
  await proxyRequest('GET', `${PAYMENT_SERVICE_URL}/payments/${req.params.id}`, req, res);
});
...
router.put('/payments/:id/pay', async (req: Request, res: Response) => {
  ...
  await proxyRequest('PUT', `${PAYMENT_SERVICE_URL}/payments/${req.params.id}/pay`, req, res);
});
